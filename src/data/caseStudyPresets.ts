...
export const MINE_CASE_STUDIES: MineCaseStudy[] = [
  {
    ...
    paperDossierText: `The simulation benchmark represents a calibrated synthetic digital twin scenario of an open-pit copper-molybdenum porphyry deposit based on typical literature parameters for Central Andean operations (altitude 4,100 m a.s.l.). Geomechanical conditions reflect moderately competent altered andesites (uniaxial compressive strength UCS = 125 MPa, in-situ rock density rho = 2.68 t/m^3, Cunningham Rock Mass Factor A = 7.2). Blasting parameters comprise 15 m benches drilled at 270 mm (10 5/8 in) diameter with an equilateral pattern (B = 6.8 m, S = 7.8 m), primed with heavy ANFO 70/30 (powder factor q = 0.78 kg/m^3). Materials handling is modeled with two P&H 4100XPC electric rope shovels (57 m^3 bucket payload ~92 t) dispatching to an ultra-class fleet of eight 240-tonne haul trucks (nominal circuit cycle distance 3.8 km with 8.5% ramp gradients). The primary gyratory crusher feeds a 36 ft x 19 ft (20 MW) SAG milling circuit targeting an optimal P80 feed of 150-160 mm with a Bond work index of 14.4 kWh/t.`
  },
  {
    id: 'skarn-cu-fe',
